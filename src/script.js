...
terrain.uniforms = {
  ...
  uElevation: { value: 2 },
  uElevationAnvarov: { value: 0.4 },
  uElevationAnvarovFrequency: { value: 1.5 },
...
gui.Register({
  folder: "terrainMaterial",
  object: terrain.uniforms.uElevationAnvarov,
  property: "value",
  type: "range",
  label: "uElevationAnvarov",
  min: 0,
  max: 1,
  step: 0.001,
});
...
gui.Register({
  folder: "terrainMaterial",
  object: terrain.uniforms.uElevationAnvarovFrequency,
  property: "value",
  type: "range",
  label: "uElevationAnvarovFrequency",
  min: 0,
  max: 10,
  step: 0.001,
});
